...
for part in inputList:
    ...
    if tempCountry in Countries:
        ...
        Countries[tempCountry] = 1  # Otherwise, put it inside the dictionary and give it value 1
...
mostOccurringAge = 0     # To save the most occurring age
counter = 0

# Loop over the Age dictionary
for tempAge in Age:
    ...
    if tempAge < Youngest:
        Youngest = tempAge
    # Access the value of each key in dictionary, counter will get the value for most occurring age
    if Age[tempAge] >= counter:
        counter = Age[tempAge]
        # Get the dictionary key equivalent to mostOccurringAge
        mostOccurringAge = tempAge

# Print the Oldest Age
print('Oldest participant is:   ', Oldest)
print('Youngest participant is: ', Youngest)
